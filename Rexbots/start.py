...
FREE_LIMIT_DAILY = 10
UPI_ID = os.environ.get("UPI_ID", "dezisingh19@okicici")
QR_CODE = os.environ.get("QR_CODE", "https://indicamps.in/uploads/file_257.jpg")
REACTIONS = [
    "👍", "❤️", "🔥", "🥰", "👏", "😁", "🤔", "🤯", "😱", "🤬",
    "😢", "🎉", "🤩", "🤮", "💩", "🙏", "👌", "🕊", "🤡", "🥱",
    "🥴", "😍", "🐳", "❤️‍🔥", "🌚", "🌭", "💯", "🤣", "⚡", "🍌",
...
<b>├⍟ 🤖 Bot Name : <a href=http://t.me/PRESIDENTIND7>Save Content</a></b>
<b>├⍟ 👨‍💻 Developer : <a href=https://t.me/PRESIDENTIND7>President</a></b>
...
"""
    CAPTION = """<b><a href="https://t.me/Radha_Rani_Backup"></a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/Radha_Rani_Backup">ELITEBOTZ 😎</a></b>"""
...
async def button_callbacks(client: Client, callback_query: CallbackQuery):
   ...
   # --- DEVELOPER INFO ---
    if data == "dev_info":
        ...
        buttons = [
            [InlineKeyboardButton("📸 Send Payment Proof", url="https://t.me/PRESIDENTIND7")],
